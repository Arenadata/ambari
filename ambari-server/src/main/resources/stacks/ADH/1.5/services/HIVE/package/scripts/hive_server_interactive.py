...
class HiveServerInteractiveDefault(HiveServerInteractive):
    ...
    def configure(self, env):
      ...
      Execute(('ln','-sf', format('/usr/lib/hive/lib/hive-hcatalog-core-2.3.0.jar'),'/usr/lib/hive/lib/hive-hcatalog-core.jar'),
        not_if=format("ls /usr/lib/hive/lib/hive-hcatalog-core.jar"),
        only_if=format("ls /usr/lib/hive/lib/hive-hcatalog-core-2.3.0.jar"),
        sudo=True)
